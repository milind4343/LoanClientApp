...
export class PagesComponent implements OnInit  {
  ...
  ngOnInit() {
    if(this.activeLinks === undefined || this.activeLinks.length === 0 ) {
      ...
      this.activeLinks.push({home:false,icon:'nb-compose',link:'',title:'Agent',children:[{title: 'Calendar',link: '/pages/extra-components/calendar'},{title: 'Stepper',link: '/pages/extra-components/stepper'}]});
